...
ID:     401
Items:  19 total — 19 done, 0 active, 0 pending, 0 blocked
...
--- Track: vault ---
  health: 5 items — 5 done (100%), 0 active, 0 pending, 0 blocked (0%)
  ...
  [done    ] #1137  Instantiate Ecological Settlement Adventure documentation tract  (assignee: -)
  [done    ] #1138  Backfill ecological settlement worldbuilding dossier  (assignee: -)
...
--- Track: dispatch ---
  ...
  [done    ] #1074  Phase F.5: live smoke (operator-gated): claude backend fills Scene 01-01 in a scratch vault; reviews fire; writer judges the voice  (assignee: -)

Rendered: 2026-07-14T13:03:12Z
